...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        registerController(server, "/api/movies/getAll", new MovieController());
        registerController(server, "/api/movies/add", new MovieController());
        registerController(server, "/api/movies/delete", new MovieController());
        registerController(server, "/api/movies/update", new MovieController());
        // Start the server
